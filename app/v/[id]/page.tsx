...
export default async function Video({ params }: PageProps) {
    ...
    const file = data.result[0];
        ...
        url: `https://bokepindonesiaterbaru.pages.dev/v/${file.filecode}#${file.title}`,
        ...
        publisher: {
            '@type': 'Organization',
            name: `${SITENAME}`,
            logo: 'https://bokepindonesiaterbaru.pages.dev/favicon.ico'},
            author: {
                '@type': 'Person',
                name: 'admin',
        ...
        interactionStatistic: {
            ...
            interactionType: {
                '@type': `ReadAction`,
                target: `https://bokepindonesiaterbaru.pages.dev/v/${file.filecode}#${file.title}`
            }  
        }
        }
    return (
